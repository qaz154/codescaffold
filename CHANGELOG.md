...
#### CLI
- **Compose preview**: Added `--preview` flag to `compose` command for dry-run project preview.
- **Unified language**: `compose` command fully translated to English.
- Preview shows file tree, dependencies, and configuration without writing files.
...
#### AI SDK
- **OpenAI SDK**: Upgraded from v4 to v6 (latest stable).
- **Anthropic SDK**: Upgraded from v0.32 to v0.100 (latest stable).
- Both SDKs maintain backward compatibility with existing code.
