...
const TEMPLATE_DESCRIPTIONS: Record<string, string> = {
  'nextjs-fullstack': 'Next.js 15 + Express + Prisma + PostgreSQL - Full-stack application template',
...
export async function listCommand() {
  ...
  try {
    ...
    console.log(chalk.gray('\nUse ') + chalk.cyan('codescaffold init') + chalk.gray(' to start creating a project'));
    console.log(chalk.gray('Or use ') + chalk.cyan('codescaffold create <name> --template <template>') + chalk.gray(' for quick generation\n'));
